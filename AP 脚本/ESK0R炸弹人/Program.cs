...
namespace Ziggs
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("随风-ESK0R炸弹人", ChampionName, true);
            ...
            Config.SubMenu("Harass")
                .AddItem(new MenuItem("ManaSliderHarass", "骚扰最低蓝量比").SetValue(new Slider(50, 100, 0)));
            Config.SubMenu("Harass")
                .AddItem(
            ...
            Config.SubMenu("Farm")
                .AddItem(new MenuItem("ManaSliderFarm", "打钱最低蓝量比").SetValue(new Slider(25, 100, 0)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            Config.SubMenu("Misc")
                .AddItem(
                    new MenuItem("WToMouse", "W 到鼠标位置").SetValue(
                        new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Misc").AddItem(new MenuItem("Peel", "使用W丨防守").SetValue(true));


            Config.AddSubMenu(new Menu("范围 设置", "Drawings"));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawQRange", "显示 Q 范围").SetValue(
                        new Circle(true, Color.FromArgb(100, 255, 0, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawWRange", "显示 W 范围").SetValue(
                        new Circle(true, Color.FromArgb(100, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawERange", "显示 E 范围").SetValue(
                        new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawRRange", "显示 R 范围").SetValue(
                        new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawRRangeM", "显示 R 范围(小地图)").SetValue(
                        new Circle(false, Color.FromArgb(100, 255, 255, 255))));
