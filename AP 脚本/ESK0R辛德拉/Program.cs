...
//            DFG = Utility.Map.GetMap().Type == Utility.Map.MapType.TwistedTreeline ? new Items.Item(3188, 750) : new Items.Item(3128, 750);
            ...
            //Create the menu
            Config = new Menu("随风-ESK0R辛德拉", ChampionName, true);
            ...
            Config.SubMenu("Misc")
                .AddItem(
                    new MenuItem("CastQE", "QE 阻止突进").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Press)));
            Config.SubMenu("Misc").AddSubMenu(new Menu("禁止R对象", "DontUlt"));
