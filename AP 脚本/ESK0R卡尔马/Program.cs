...
namespace Karma
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("随风-ESK0R卡尔马", ChampionName, true);
            ...
            _config.SubMenu("连招 按键").AddItem(new MenuItem("UseQCombo", "使用 Q").SetValue(true));
            _config.SubMenu("连招 按键").AddItem(new MenuItem("UseWCombo", "使用 W").SetValue(true));
            _config.SubMenu("连招 按键").AddItem(new MenuItem("UseRCombo", "使用 R").SetValue(true));
            ...
            _config.AddSubMenu(new Menu("杂项 设置", "Misc"));
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEDefense", "使用 E丨保护队友").SetValue(true));
