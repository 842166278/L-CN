...
namespace Orianna
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("随风-ESK0R发条", ChampionName, true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRNCombo", "连招最后使用R丨敌人数").SetValue(new StringList(new string[]{"1 个人", "2 个人", "3 个人", "4 个人", "5 个人"}, 0)));
            ...
            #region Misc
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoW", "Auto W if it'll hit").SetValue(new StringList(new string[] { "禁止", ">=1 个人", ">=2 个人", ">=3 个人", ">=4 个人", ">=5 个人" }, 2)));
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoR", "自动 R丨可以命中对方").SetValue(new StringList(new string[] { "禁止", ">=1 个人", ">=2 个人", ">=3 个人", ">=4 个人", ">=5 个人" }, 3)));
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoEInitiators", "自动 E 回去").SetValue(true));
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("InterruptSpells", "使用R丨打断技能").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("BlockR", "防止连招时空大").SetValue(false));
            #endregion
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("HarassManaCheck", "MP 低于 %时丨禁止骚扰对方").SetValue(new Slider(0, 0, 100)));
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseQFarm", "使用 Q").SetValue(
                        new StringList(new[] { "Freeze", "清线", "两者", "禁止" }, 2)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseWFarm", "使用 W").SetValue(
                        new StringList(new[] { "Freeze", "清线", "两者", "禁止" }, 1)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("FreezeActive", "控线 按键!").SetValue(
                        new KeyBind(Config.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("LaneClearActive", "清线 按键!").SetValue(
                        new KeyBind(Config.Item("清线").GetValue<KeyBind>().Key, KeyBindType.Press)));

            //JungleFarm menu:
            Config.AddSubMenu(new Menu("清野 设置", "JungleFarm"));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("QOnBallRange", "显示 球 位置").SetValue(new Circle(true, Color.FromArgb(150, Color.DodgerBlue))));
            Config.SubMenu("Drawings")
